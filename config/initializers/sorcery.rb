...
Rails.application.config.sorcery.submodules = [:user_activation, :reset_password, :remember_me, :brute_force_protection, :activity_logging]
...
Sorcery::CryptoProviders::BCrypt.cost = Rails.application.config.rails_template_app.sorcery_bcrypt_cost
