class User < ActiveRecord::Base
  ...
  validates_presence_of     :password, on: :create, unless: :old_password_incorrect?
  validates_length_of       :password, :minimum => 4, if: :password, unless: :old_password_incorrect?
  validates_presence_of     :password_confirmation, if: :password, unless: :old_password_incorrect?
